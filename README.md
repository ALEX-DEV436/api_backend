...
<p>Bem-vindos ao meu projeto!
  ...
  Vamos desenvolver uma API utilizando o Node.js para back-end e o React no front-end. Nossa (API) devera comunicar com uma API externa - (utilizaremos a da star - wars) para conseguir responder conforme seja solicitadao pelo usuario com acesso ao nosso sistema. Esta aplicação devera seguir as diretrizes REST,  garantindo que a comunicação entre o servidor e o cliente seja super suave e padronizada. E um adendo, apesar de desenvolver aplicações web a muitos anos eu, nunca trabalhei com estas ferramentas.Ou seja, a portunidade de quem tá começando acompanhar o inicio de uma viagem na construção de uma aplicação completa vamos trabalhar na frente e nos bastidores de uma aplicação, vamos resolver um problema e aprendera novos conhecimentos, ou seja voce vai vivencia a inquietude na vida de um desenvolvedor Full Stack, antes deste projeto já estou criando o game com c# e unity. Venha comigo nesta jornada e vamos juntos descobrir as possibilidades e oportunidades que estas ferramentas podem oferecer.Vai ser divertido!!let's go!  
</p>
